...
-file("src/gleam/erlang.gleam", 18).
?DOC(
...
-file("src/gleam/erlang.gleam", 28).
?DOC(
...
-file("src/gleam/erlang.gleam", 81).
?DOC(
...
-file("src/gleam/erlang.gleam", 94).
?DOC(
...
-file("src/gleam/erlang.gleam", 100).
?DOC(
...
-file("src/gleam/erlang.gleam", 110).
?DOC(
...
-spec rescue(fun(() -> EXH)) -> {ok, EXH} | {error, crash()}.
rescue(A) ->
    gleam_erlang_ffi:rescue(A).

-file("src/gleam/erlang.gleam", 42).
?DOC(
...
-file("src/gleam/erlang.gleam", 57).
?DOC(
...
-file("src/gleam/erlang.gleam", 125).
?DOC(
...
-file("src/gleam/erlang.gleam", 148).
?DOC(
...
-file("src/gleam/erlang.gleam", 209).
?DOC(
...
-file("src/gleam/erlang.gleam", 220).
?DOC(
...
-file("src/gleam/erlang.gleam", 224).
