...
async fn test_scheduler_placement_decisions() {
    ...
    println!(
        "Placement 1: node {}, reason: {}",
        placement1.selected_node_id, placement1.reason
    );
    ...
    println!(
        "Cluster summary: {} nodes, {}vCPU total, {}MB RAM total",
    ...
    let placement2 = leader
        .shared_state
        .schedule_vm_placement(&vm2, PlacementStrategy::Manual { node_id: 2 })
        .await
