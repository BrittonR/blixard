    ...
    for i in 0..100 {
        // Simulate a Raft proposal
        {
            let _timer = Timer::with_attributes(
                ...
                vec![attributes::node_id(1), attributes::operation("create_vm")],
            );

            metrics
                .raft_proposals_total
                .add(1, &[attributes::node_id(1)]);
            ...
            if i % 7 == 0 {
                metrics
                    ...
                    .add(1, &[attributes::node_id(1), attributes::error(true)]);
            }
        }
        ...
        if i % 5 == 0 {
            metrics
                .peer_reconnect_attempts
                .add(1, &[attributes::peer_id(2)]);
        ...
        if i % 3 == 0 {
            ...
            metrics
                .storage_reads
                .add(1, &[attributes::table("cluster_state")]);
        ...
        // Simulate storage operations
        {
            ...
            metrics
                .storage_writes
                .add(1, &[attributes::table("vm_state")]);
...
impl RaftNode {
    async fn propose(&self, data: &[u8]) -> Result<(), String> {
        ...
        let _timer = Timer::with_attributes(metrics.raft_proposal_duration.clone(), attrs.clone());
