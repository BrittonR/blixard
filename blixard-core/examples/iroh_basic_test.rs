...
async fn main() -> BlixardResult<()> {
    ...
    let addr2 = NodeAddr::new(endpoint2.node_id())
        .with_direct_addresses(endpoint2.bound_sockets());
    
    println!("Endpoint 1: {}", endpoint1.node_id());
    println!("  Addresses: {:?}", addr1.direct_addresses().collect::<Vec<_>>());
    println!("Endpoint 2: {}", endpoint2.node_id());
    println!("  Addresses: {:?}", addr2.direct_addresses().collect::<Vec<_>>());
