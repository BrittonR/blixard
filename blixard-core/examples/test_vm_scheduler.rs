...
use blixard_core::{
    ...
    storage::{init_database_tables, WORKER_STATUS_TABLE, WORKER_TABLE},
    types::{LocalityPreference, VmConfig},
...
async fn main() -> BlixardResult<()> {
        ...
        .await
    {
        Ok(decision) => {
            println!(
                "  ✓ Large VM placement successful on node {}",
