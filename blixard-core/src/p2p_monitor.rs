...
impl P2pMonitor for NoOpMonitor {
    ...
    async fn record_connection_state_change(&self, _peer_id: &str, _from: ConnectionState, _to: ConnectionState) {}
    async fn record_bytes_transferred(&self, _peer_id: &str, _direction: Direction, _bytes: u64) {}
    async fn record_message(&self, _peer_id: &str, _message_type: &str, _size: usize, _latency_ms: Option<f64>) {}
    ...
    async fn record_resource_sync(&self, _peer_id: &str, _resource_type: &str, _bytes: u64, _duration_ms: f64, _success: bool) {}
}