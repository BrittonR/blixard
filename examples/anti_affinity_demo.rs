...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let web_anti_affinity = AntiAffinityRules::new()
        .add_rule(AntiAffinityRule::hard("web-frontend"));
    ...
    let cache_anti_affinity = AntiAffinityRules::new()
        .add_rule(AntiAffinityRule::soft("cache-layer", 0.8));
    ...
    let db_anti_affinity = AntiAffinityRules::new()
        .add_rule(
            AntiAffinityRule::hard("postgres-cluster")
                .with_max_per_node(2)
        );
    ...
    let multi_anti_affinity = AntiAffinityRules::new()
        ...
        .add_rule(
            AntiAffinityRule::hard("region-us-east")
                .with_scope("datacenter")
        );
    ...
    info!("VM '{}': No anti-affinity constraints", optional_vm_without_rules.name);
    ...
    let versioned_anti_affinity = AntiAffinityRules::new()
        .add_rule(AntiAffinityRule::hard("app-v2.1.0-blue"));
